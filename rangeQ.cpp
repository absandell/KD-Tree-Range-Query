...
int rangeQuery(int searchOption, string databaseFile, string queryFile, int indexBlock) {
	...
	if (searchOption == 0) { // Sequential Search
		...
		fstream qu;
		ofstream outputFile;
		outputFile.open("SequentialOutput.txt"); // To Erase prior contents
		outputFile.close();
		...
		fstream qu;
		ofstream outputFile;
		outputFile.open("KD-TreeOutput.txt"); // To Erase prior contents
		outputFile.close();
		...
		fstream qu;
		ofstream outputFile;
		outputFile.open("MyKD-TreeOutput.txt"); // To Erase prior contents
		outputFile.close();
